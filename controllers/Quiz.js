...
// Mengubah data seusai id yang dikirimkan
exports.update = async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: "Quezzes updated succesfully.",
            data: quiz,
        });
    }   catch (error) {
        res.status(500).json({
...
exports.delete = async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: "Quezzes deleted succesfully.",
        });
    }   catch (error) {
        res.status(500).json({
            message: error.message || "some error occurred while retrieving quiz",
...
exports.findOne = async (req, res) => {
    ...
    try {
        ...
        res.json({
            message: "Quezzes retrieved succesfully with id=${id}.",
            data: quiz,
        });
    }   catch (error) {
        res.status(500).json({
...
exports.getByCategoryId = async (req, res) => {
    ...
    const quizzes = await Quiz.findAll({
        ...
        res.json({
            message: "Quezzes retrieved succesfully with categoryId=${id}.",
            data: quizzes,
        });
    }
...
exports.getByLevelId = async (req, res) => {
    ...
    const quizzes = await Quiz.findAll({
        ...
        res.json({
            message: "Quezzes retrieved succesfully with levelId=${id}.",
            data: quizzes,
        });
    }